...
class AddPostUseCase extends BaseUseCase<DataForAddPost, PostData> {
  final BasePostRepository _basePostRepository;

  AddPostUseCase(this._basePostRepository);

  @override
  Future<Either<Failure, PostData>> call(DataForAddPost input) async {
    return await _basePostRepository.addPostRepository(input);
  }
}
