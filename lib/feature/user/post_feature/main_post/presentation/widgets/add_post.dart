...
import '../controller/main_post_cubit/manage_profile_post.dart';
...
class _AddPostDialogState extends State<AddPostDialog> {
  Future<void> _pickImage() async {
    if (kIsWeb) {
      ...
      if (result != null && result.files.isNotEmpty) {
        setState(() {
          BlocProvider.of<ManageProfilePost>(context).selectedWebImage = result;
        });
      }
    } else {
      ...
      setState(() {
        BlocProvider.of<ManageProfilePost>(context).selectedImage = image;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    final cubit = BlocProvider.of<ManageProfilePost>(context);
    //final loadPostData = BlocProvider.of<LoadPostCubit>(context);
    return AlertDialog(
