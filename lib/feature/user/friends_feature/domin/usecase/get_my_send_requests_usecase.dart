...
class GetMySendRequestsUseCase extends BaseUseCase <String, List<FriendData>> {
  final BaseFriendRepository _baseFriendRepository;

  GetMySendRequestsUseCase(this._baseFriendRepository);

  @override
  Future<Either<Failure, List<FriendData>>> call(String input) async {
    return await _baseFriendRepository.getMyRequestSendRepository(input);
  }
}